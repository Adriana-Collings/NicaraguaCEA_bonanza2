...
class Patient:
    ...
    def __init__(self, id):
        ...
        probs = np.random.dirichlet(alpha=(0.075, # 1
                                           0.036, # 2
                                           0.005, # 3
                                           0.014, # 6
                                           0.006, # 12
...
# what you are trying to do now is build a function in R that will tell you the concentration of each disease to input above
    ...
    def simulate(self, n_of_patients):
        ...
        #if self.draw == 'd':
        #    import __DT_Condition_4 as D
        #if self.draw == 'e':
        #    import _DT_Condition_5 as D
        if self.draw == 'f':
            import DT_Condition_6 as D
        #if self.draw == 'g':
        #    import __DT_Condition_8 as D
        #if self.draw == 'h':
        #    import __DT_Condition_10 as D
        if self.draw == 'i':
        ...
        #if self.draw == 'm':
        #    import __DT_Condition_17 as D
        #if self.draw == 'n':
        #    import _DT_Condition_18 as D
        #if self.draw == 'o':
        #    import __DT_Condition_19 as D
        #if self.draw =='p':
        #    import _DT_Condition_20 as D
        #if self.draw =='q':
        #    import _DT_Condition_22 as D
        #if self.draw == 'r':
        #    import __DT_Condition_24 as D
        if self.draw == 's':
            import DT_Condition_25 as D
        #if self.draw =='t':
        #    import __DT_Condition_28 as D
        #if self.draw == 'u':
        #    import __DT_Condition_30 as D
        if self.draw == 'v':
            import DT_Condition_32 as D
        #if self.draw == 'w':
        #    import _DT_Condition_33 as D
        #if self.draw == 'x':
        #    import __DT_Condition_34 as D
        #if self.draw == 'y':
        #    import __DT_Condition_35 as D
        if self.draw == 'z':
        ...
        #if self.draw == 'gg':
        #    import __DT_Condition_47 as D
        if self.draw == 'hh':
            import DT_Condition_48 as D
        #if self.draw == 'ii':
        #    import __DT_Condition_49 as D
        #if self.draw == 'jj':
        #    import __DT_Condition_50 as D
        #if self.draw =='kk':
        #    import _DT_Condition_51 as D
        #if self.draw =='ll':
        #    import __DT_Condition_53 as D
        #if self.draw == 'mm':
        #    import _DT_Condition_54 as D
        #if self.draw == 'nn':
        #    import __DT_Condition_59 as D
...
class YearofPatients:
    def __init__(self, id):
        ...
        self._initial_pop_size_pre= 977
        self._initial_pop_size_post = 1094
